  ...
  return (
    <div>
      <main className="container text-center py-5 mb-5">
        <h1 className="mb-5">Pixel Birds</h1>
        <h2 className="my-5">
        ...
        <div className="d-flex flex-column flex-sm-row justify-content-around bg-sunshine rounded">
          <figure className="figure">
            <a className="text-decoration-none" target="_blank" rel="noreferrer" href="https://www.stargaze.zone/launchpad/stars1nc5rsfwnnlf4r7xjnh5agr8mk82q0m5n0drcmd6f0977ygh2ld7svz2xl4">
              <figcaption className="figure-caption p-2">Mint Page.</figcaption>
              <Image src="/images/Mint.png" width="300" height="300" alt="Mint Page" className="img-fluid border rounded shadow homepage-pictures" />
            </a>
          </figure>
          <figure className="figure">
            <a className="text-decoration-none" target="_blank" rel="noreferrer" href="https://www.stargaze.zone/marketplace/stars1d5frtu2txpy2c5v9jg60wqju2qk8cm8xg3k7s4k863m4hg9mt70sxlxtq2?sort=price_asc">
              <figcaption className="figure-caption p-2">Marketplace.</figcaption>
              <Image src="/images/Marketplace.png" width="300" height="300" alt="Marketplace" className="img-fluid border rounded shadow homepage-pictures" />
            </a>
          </figure>
        </div>
        ...
        <div className="card bg-warning m-md-5 p-md-5 py-3">
          ...
          <Image src="/images/Velthium.jpg" width="300" height="300" alt="Velthium" className="img-fluid mx-auto border rounded shadow homepage-pictures" />
        </div>
      </main>
    </div>
  );
